...
//                            BIT2    BIT1    BIT0
//                          -------------------------
#define PCA_ADDR_1 0x01  //   PD(2)   PD(2)   PU(4)
#define PCA_ADDR_2 0x02  //   PD(2)   PD(2)   PD(2)
#define PCA_ADDR_3 0x03  //   PD(2)   PD(2)   GND(1)
#define PCA_ADDR_4 0x23  //   PD(2)   PD(2)   VDD(5)
// 0x23 to 0x20 + 0x1f, this would be modified due to the final design
#define PCA_ADDR_5 0x20
#define PCA_ADDR_6 0x1f
